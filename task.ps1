...
New-AzVm -ResourceGroupName $resourceGroupName -Name $vmName1 -Location $location -Zone 1 -image $vmImage -size $vmSize -SubnetName $subnetName -VirtualNetworkName $virtualNetworkName -SecurityGroupName $networkSecurityGroupName -SshKeyName $sshKeyName
# -PublicIpAddressName $publicIpAddressName

New-AzVm -ResourceGroupName $resourceGroupName -Name $vmName2 -Location $location -Zone 2 -image $vmImage -size $vmSize -SubnetName $subnetName -VirtualNetworkName $virtualNetworkName -SecurityGroupName $networkSecurityGroupName -SshKeyName $sshKeyName